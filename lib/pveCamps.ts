...
export const DIFFICULTY_MULT: Record<Difficulty, { enemyCount: number; enemyHp: number; cost: number; reward: number; label: string; color: string }> = {
  easy:   { enemyCount: 1.4, enemyHp: 1.2, cost: 1.0, reward: 1.0, label: 'Makkelijk', color: '#6BA368' },
  normal: { enemyCount: 2.6, enemyHp: 2.2, cost: 1.5, reward: 2.5, label: 'Normaal',   color: '#E8B84A' },
  hard:   { enemyCount: 4.0, enemyHp: 3.5, cost: 2.5, reward: 5.0, label: 'Moeilijk',  color: '#C75B3D' },
};
