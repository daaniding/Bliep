 ...
 *
 * 120 cols × 90 rows — large organic island shape with zones:
 *   - Village center (buildings, shops)
 *   - Farm zone (crops, windmill)
 *   - Forest zone (trees, resources)
 *   - Coast zone (fishing, docks)
 *   - Military zone (barracks, towers)
 *
 * Each character:
 *   .  = water
