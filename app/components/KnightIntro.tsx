 ...
 * warrior sprite stands at the top with a speech bubble, and three wood-card
 * task choices below.
 *
...
export default function KnightIntro({ tasks, onPick }: Props) {
  return (
    <div
      className="fixed inset-0 z-[200] flex flex-col items-stretch px-3 py-6 overflow-y-auto"
      style={{
        background:
    ...
    >
      <div className="flex flex-col items-center gap-2 mb-4 mt-4">
        ...
        <div
          className="px-4 py-2 rounded-lg border-2 border-[#1a0f05] relative max-w-[300px] text-center mt-2"
          style={{
